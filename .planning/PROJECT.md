...
## Current Milestone: v2.0 Otaku-Rich Design Overhaul

**Goal:** Stitch / Figma MCP / デザインツールをフル活用し、アニメ・オタク文化を体現するリッチなビジュアルデザインで UI/UX を全面刷新する

**Target features:**
- デザインシステム再構築（オタク文化ビジュアル、ネオン/グラデーション、新カラーパレット）
- レイアウト・ナビゲーション動線の全面刷新
- 全 UI コンポーネントのビジュアルオーバーホール
- モーション・インタラクション設計（WIP システムの統合・拡張）
- アクセシビリティ & パフォーマンス最適化

## State (v1.0 shipped 2026-03-28)
...
- [ ] デザインシステム再構築（オタク文化ビジュアル）
- [ ] レイアウト・ナビゲーション全面刷新
- [ ] 全 UI コンポーネントビジュアルオーバーホール
- [ ] モーション・インタラクション設計
- [ ] アクセシビリティ & パフォーマンス最適化
