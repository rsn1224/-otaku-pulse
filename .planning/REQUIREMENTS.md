...
- [ ] **RESL-01**: scheduler の collect_loop / digest_loop に CancellationToken を導入し、グレースフルシャットダウンを実装する
- [ ] **RESL-02**: SchedulerConfig を Arc<RwLock> でラップし、設定変更を Tauri event で稼働中ループに即時通知する
