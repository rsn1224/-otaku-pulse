...
pub const DEFAULT_FEEDS: &[(&str, &str, &str, &str)] = &[
    ...
    ("Anime Corner", "https://animecorner.me/feed", "anime", "rss"),
    ("Crunchyroll News", "https://cr-news-api-service.prd.crunchyrollsvc.com/v1/en-US/rss", "anime", "rss"),
    // Manga
    ("コミックナタリー", "https://natalie.mu/comic/feed/news", "manga", "rss"),
    ("Otaku USA", "https://otakuusamagazine.com/anime/feed", "manga", "rss"),
    // Game
    ...
    ("ITmedia", "https://rss.itmedia.co.jp/rss/2.0/topstory.xml", "pc", "rss"),
];
